...
select Max(quantitiy) as"Minimum Quantity" from products;
select product,quantitiy,price from products where quantitiy=(select max(quantitiy) as "minimum quantity" from products);