...
select Min(quantitiy) as"Minimum Quantity" from products;
select product,quantitiy,price from products where quantitiy=(select min(quantitiy) as "minimum quantity" from products);